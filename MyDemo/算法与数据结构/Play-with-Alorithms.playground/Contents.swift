...
tmpG2.hasEdge(5, 8)
tmpG2.deleteEdge(5, 8)
tmpG2.hasEdge(5, 8)
tmpG2.hasEdge(5, 7)
tmpG2.show()

tmpG2.deleteEdge(5, 6)
tmpG2.deleteEdge(5, 7)
let path821 = DenseGraph_Matrix.Path(graph: tmpG2, v: from)
let path21 = path82.path(with: to)
path821.showPath(with: to)
//
